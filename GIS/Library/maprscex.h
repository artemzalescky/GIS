/******* MAPRSCEX.H  *********** Panteleeva N.A. ****** 17/09/09 ***
******** MAPRSCEX.H  *********** Kruzhkov A.E.   ****** 23/04/06 ***
******** MAPRSCEX.H  *********** Belenkov O.V.   ****** 21/05/09 ***
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 long int WINAPI mapGetRscImlIndex(HRSC hRsc,int number);  // 23/04/06

 // Запрос кода по порядковому номеру библиотеки (c 1)
 // При ошибке возвращает ноль

 long int WINAPI mapGetRscImlCode(HRSC hRsc,int number);   // 23/04/06
 ...
 // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  // hDrw - идентификатор набора примитивов
  // При ошибке возвращает 0 (устаревшая, пользуйтесь mapRscDrawCount)
...
//  long int WINAPI mapDrawCount(HDRAW hDrw);
  ...
  long int WINAPI mapRscDrawCount(HDRAW hDrw);       // 17/09/09
  ...
  // hDrw - идентификатор набора примитивов
  // При ошибке возвращает ноль (устаревшая, пользуйтесь mapRscClearDraw)
  ...
  long int WINAPI mapRscClearDraw(HDRAW hDrw);                // 17/09/09
  ...
  long int WINAPI mapAppendBMPtoDraw(HDRAW hDrw, const char * name);
