/******  MAPCREAT.H  ***********  Belenkov  O.V. *****  06/03/12 ***
*******  MAPCREAT.H  ***********  Shishkova L.A. *****  15/02/12 ***
*******  MAPCREAT.H  ***********  Tarakanova I.R.*****  17/08/10 ***
...
// UNDEFINED   = -1,      // Не установлено
   ...
   MERCATOR     = 19,     // Цилиндрическая Меркатора на шаре "World Mercator" EPSG:3857 
                          //(аналог Google), можно выбрать эллипсоид
   SEANAUTIC    = 20,     // Морская навигационная (Mercator_1SP), можно выбрать эллипсоид
                          // (Цилиндрическая равноугольная Меркатора на эллипсоиде WGS84)
   MAPTYPELIMIT = 20,     // Крайнее значение типа карты                    // 12/01/12
  }
   MAPTYPE;
...
// UNDEFINED                   = -1, // Не установлено
   ...
   LATITUDELONGITUDE           = 33, // Широта/Долгота Цилиндрическая на шаре                   // 15/04/10
   ...
   LASTPROJECTIONNUMBER        = 36, // Крайний номер проекции
  }
   MAPPROJECTION;
  ...
  {
   UNDEFINED     = -1,     // Не установлено
   KRASOVSKY42   =  1,     // Красовского 1942г.(6378245.0, 298.3)
   ...
   KRASOVSKY42_95 = 1001,  // Красовского 1942г. СК-95  (don,t use)
...
// UNDEFINED    = -1,     // Не установлено
  ...
  {
// UNDEFINED   = -1,      // Не установлено
   TOPOGRAPHIC  = 1,      // Топографическая (СК42)
   ...
   CK_95        = 14,     // Система координат 95 года  // 02/05/07
   TOPOLOCAL    = 15,     // Топографическая с произвольной главной точкой  // 24/12/09 (Transverse Mercator)
   MAPSPHERE    = 16,     // Обзорно-географическая Широта/Долгота на шаре  // 15/04/10
   WORLDMAP     = 17,     // Карта Мира (Цилиндрическая Миллера)            // 22/12/10
   MCK_CK63     = 18,     // Местная система координат на базе СК-63        // 28/02/11
   MERCATOR     = 19,     // Цилиндрическая Меркатора на шаре "World Mercator" EPSG:3857
   SEANAUTIC    = 20,     // Морская навигационная (Mercator_1SP)
                          // (Цилиндрическая равноугольная Меркатора на эллипсоиде WGS84)
   MAPTYPELIMIT = 20,     // Крайнее значение типа карты                    // 12/01/12
  };
...
int         ReliefHeight           ;  // Высота сечения рельефа в дециметр
...
// ПЗ-90.02  ->  WGS-84
#define DX_SGS85_WGS84      -0.36L
#define DY_SGS85_WGS84      +0.08L
#define DZ_SGS85_WGS84      +0.18L
#define RX_SGS85_WGS84       0.0L
#define RY_SGS85_WGS84       0.0L
#define RZ_SGS85_WGS84       0.0L
...
typedef struct EPSGRECTSYS
{
  ...
  AXISDIR  XDirection;         // направление оси Х (первой координаты)
  AXISDIR  YDirection;         // направление оси Y (второй координаты)
